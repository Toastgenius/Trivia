...
namespace TRIVIA
{
    ...
    public class Trivia : TerrariaPlugin
    {
        ...
        public static trivia[] DefaultTrivia = new trivia[]
        {
            ...
            new trivia("What game uses a deck of cards, a board with holes in it, and small wooden pegs?","Cribbage"),
            new trivia("The oldest street in San Francisco was originally called Dupont Street, but was later re-named after a President. Which street is this?","Grant Street"),
            ...
            new trivia("What was a gladiator armed with, in addition to a dagger and spear?","A Net"),
            new trivia("What single name is more commonly applied to Holy Roman Emperor Charles the Great?","Charlemagne"),
            new trivia("What had Pliny the Younger seen erupt when he wrote: \"We were terrified to see everything changed, buried in ashes like snowdrifts?\"Mount Vesuvius"),
            new trivia("One of the last words in the dictionary refer to a supernatural power than can bring a corpse back to life. What is it?","Zombie"),
            new trivia("In One Piece, who was the first main character added as a crewmate?","Roronoa Zoro"),
            new trivia("In Fairy Tail, what type of mage is Lucy Heartfilia","Celestial"),
            new trivia("Which anime made by CLAMP was named after a plant?","Sakura"),
            new trivia("What is the name of the cat in the smurfs?","Azriel"),
            new trivia("What was the name of the dog in Fraggle Rock?","Sprocket"),
            new trivia("What was the name of Punky Brewster's dog?","Brandon"),
            new trivia("What was ALF's girlfriend from Melmac's name?","Rhonda"),
            new trivia("What was the name of Facts of Life's Mrs. Garret's gourmet food shop?","Edna's Edibles"),
            new trivia("On Little House on the Prarie, what was the original name for the school teacher?","Miss Beatle"),
            new trivia("Where is Notre Dame?","Paris"),
            new trivia("All women are Ironman, explain","Fe is iron male is man),
            new trivia("What bird was domesticated first?","Goose"),
            new trivia("Which planet spins the fastest?","Jupiter"),
            new trivia("Which Planet spins the slowest?","Venus"),
            new trivia("What is the Milky Way?","Spiral Galaxy"),
            new trivia("What tree gives us prunes?","Plum Tree"),
            new trivia("What falling fruit supposedly inspired Isaac Newton to write the laws of gravity?","Apple"),
            new trivia("What's the groundnut better known as?","The Peanut"),
            new trivia("What is someone who shoes horses called?","A Farrier"),
            new trivia("What item of clothing was named after its Scottish inventor?","A Macintosh"),
            new trivia("What kind of weapon is a falchion? A sword","A sword"),
            new trivia("Which word goes before vest, beans and quartet?","String"),
            new trivia("What is another word for lexicon?","Dictionary"),
            new trivia("Name the seventh planet from the sun","Uranus"),
            new trivia("How many valves does a trumpet have?","Trumpet"),
            new trivia("Which Shakespeare play features Shylock?","The Merchant Of Venice"),
